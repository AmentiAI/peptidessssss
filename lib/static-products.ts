...
export const staticCategories: StaticCategory[] = [
  { id: "cat-1", name: "Muscle Growth", slug: "muscle-growth", icon: "TrendingUp", color: "#2563eb", description: "Peptides that promote lean muscle growth, enhance recovery, and support GH secretion.", heroDescription: "Research peptides for muscle growth and body composition optimization.", seoDescription: "Research peptides for muscle growth including Ipamorelin, CJC-1295, BPC-157, and more.", stats: [], content: null, faq: [], sortOrder: 0, createdAt: new Date(), updatedAt: new Date() },
  { id: "cat-2", name: "Recovery & Repair", slug: "recovery-repair", icon: "Zap", color: "#16a34a", description: "Peptides that accelerate tissue healing, reduce inflammation, and speed recovery.", heroDescription: "The most studied tissue repair peptides for injury recovery and healing.", seoDescription: "Recovery peptides including BPC-157, TB-500, and more for tissue repair.", stats: [], content: null, faq: [], sortOrder: 1, createdAt: new Date(), updatedAt: new Date() },
  { id: "cat-3", name: "Anti-Aging", slug: "anti-aging", icon: "Clock", color: "#9333ea", description: "Peptides that combat cellular aging, activate telomerase, and promote longevity.", heroDescription: "Research peptides targeting the fundamental hallmarks of aging.", seoDescription: "Anti-aging peptides including Epithalon, GHK-CU, and MOTS-C.", stats: [], content: null, faq: [], sortOrder: 2, createdAt: new Date(), updatedAt: new Date() },
  { id: "cat-4", name: "Weight Loss", slug: "weight-loss", icon: "Flame", color: "#ea580c", description: "Peptides that support fat metabolism, reduce appetite, and improve body composition.", heroDescription: "Research peptides for weight management and metabolic health.", seoDescription: "Weight loss peptides including Tirzepatide, AOD9604, Retatrutide and more.", stats: [], content: null, faq: [], sortOrder: 3, createdAt: new Date(), updatedAt: new Date() },
  { id: "cat-5", name: "Brain/Nerve", slug: "brain-nerve", icon: "Brain", color: "#0891b2", description: "Nootropic peptides that enhance cognition, memory, and neuroprotection.", heroDescription: "Research peptides for cognitive enhancement and neuroprotection.", seoDescription: "Brain peptides including Semax, Selank, Cerebrolysin, and more.", stats: [], content: null, faq: [], sortOrder: 4, createdAt: new Date(), updatedAt: new Date() },
  { id: "cat-6", name: "Immunity", slug: "immunity", icon: "Shield", color: "#15803d", description: "Peptides that strengthen immune function, reduce inflammation, and fight infection.", heroDescription: "Immune-boosting research peptides for enhanced immune function.", seoDescription: "Immune peptides including Thymosin Alpha-1, Thymulin, and LL-37.", stats: [], content: null, faq: [], sortOrder: 5, createdAt: new Date(), updatedAt: new Date() },
  { id: "cat-7", name: "Libido", slug: "libido", icon: "Heart", color: "#e11d48", description: "Peptides that support sexual health, enhance libido, and improve reproductive function.", heroDescription: "Research peptides for sexual health and libido enhancement.", seoDescription: "Libido peptides including PT-141, Kisspeptin-10, MT-2, and Kiss Peptides Cycle.", stats: [], content: null, faq: [], sortOrder: 6, createdAt: new Date(), updatedAt: new Date() },
  { id: "cat-8", name: "Skin/Tissue/Bone", slug: "skin-tissue-bone", icon: "Star", color: "#d97706", description: "Peptides for skin regeneration, collagen synthesis, hair growth, and bone health.", heroDescription: "Research peptides for skin, tissue, and bone regeneration.", seoDescription: "Skin and tissue peptides including GHK-CU, BPC-157, LL-37, and more.", stats: [], content: null, faq: [], sortOrder: 7, createdAt: new Date(), updatedAt: new Date() },
  { id: "cat-9", name: "Peptides Cycles", slug: "peptides-cycles", icon: "Package", color: "#7c3aed", description: "Pre-built synergistic peptide cycles for comprehensive results.", heroDescription: "Complete peptide cycles for focused research goals.", seoDescription: "Peptide cycles including Wolverine Cycle, Glow Plus Cycle, Nova Mind Cycle, and more.", stats: [], content: null, faq: [], sortOrder: 8, createdAt: new Date(), updatedAt: new Date() },
  { id: "cat-10", name: "Supplies", slug: "supplies", icon: "Package2", color: "#6b7280", description: "Reconstitution supplies: bacteriostatic water, syringes, alcohol pads, and starter kits.", heroDescription: "Everything you need to prepare and administer research peptides.", seoDescription: "Peptide research supplies including bacteriostatic water, syringes, and starter kits.", stats: [], content: null, faq: [], sortOrder: 9, createdAt: new Date(), updatedAt: new Date() },
]
