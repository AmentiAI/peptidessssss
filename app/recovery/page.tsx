...
import { ArrowRight, Zap, Shield, Heart, Activity, ChevronRight } from "lucide-react"
...
const BENEFITS = [
  {
    icon: Activity,
    title: "Angiogenesis",
    desc: "BPC-157 and TB-500 promote new blood vessel formation, accelerating nutrient delivery to injured tissue.",
    color: "#ef4444",
  },
  {
    icon: Shield,
    title: "Anti-Inflammatory",
    desc: "Downregulation of COX-2 and pro-inflammatory cytokines to reduce chronic inflammation at the site of injury.",
    color: "#f59e0b",
  },
  {
    icon: Zap,
    title: "Tendon & Ligament Repair",
    desc: "Research shows BPC-157 accelerates tendon-to-bone healing and collagen fiber realignment after acute injury.",
    color: "#3b82f6",
  },
  {
    icon: Heart,
    title: "Systemic Protection",
    desc: "LL-37 and Thymosin Alpha-1 provide broad immune modulation and systemic repair alongside localized peptides.",
    color: "#10b981",
  },
]

export default function RecoveryPage() {
  const products = RECOVERY_SLUGS
  ...
  return (
    <PageLayout>
      ...
      {/* HERO */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-red-950/30 to-slate-900 text-white py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-red-500/40 bg-red-500/10 mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                ...
                className="flex items-center gap-2 px-8 py-4 rounded-xl font-bold bg-red-500 text-white hover:bg-red-400 transition-colors text-base"
              >
                Shop Recovery Peptides <ArrowRight className="w-4 h-4" />
              </Link>
              <Link
              ...
              <Link
                href="/categories/recovery-repair"
        ...
        <div className="absolute right-0 top-0 w-64 h-64 bg-red-500/5 rounded-full blur-3xl" />
        <div className="absolute right-20 bottom-0 w-40 h-40 bg-orange-500/5 rounded-full blur-2xl" />
      </section>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map((product) => (
            <div key={product.slug} className="group rounded-2xl border border-slate-200 hover:border-red-300 hover:shadow-lg transition-all duration-300 overflow-hidden bg-white">
              ...
              <div className="p-5">
                <div className="flex flex-wrap gap-1 mb-2">
                  {product.categories.slice(0, 2).map((cat) => (
                    <span key={cat} className="px-2 py-0.5 rounded-full text-[10px] font-semibold bg-red-50 text-red-700 border border-red-100">
                      {cat}
                    </span>
                  ))}
                </div>
                ...
                <div className="flex gap-2 pt-3 border-t border-slate-100">
                  ...
                  <Link
                    ...
                    target="_blank"
                    className="flex-1 text-center py-2.5 rounded-xl text-sm font-bold bg-red-500 text-white hover:bg-red-400 transition-colors"
                  >
                    Buy Now →
                  </Link>
                </div>
        ...
        <div className="rounded-3xl bg-gradient-to-r from-red-50 to-orange-50 border border-red-100 p-8 lg:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { stat: "400+", label: "Published Studies" },
                { stat: "15 AA", label: "Peptide Length" },
                { stat: "≥99%", label: "COA Purity" },
                { stat: "Systemic", label: "Delivery Route" },
              ].map(({ stat, label }) => (
                <div key={label} className="p-5 rounded-2xl bg-white border border-red-100 text-center">
                  <div className="text-3xl font-bold text-red-500 mb-1">{stat}</div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={AFFILIATE_URL} target="_blank" rel="nofollow sponsored noopener noreferrer"
              className="flex items-center justify-center gap-2 px-10 py-4 rounded-xl font-bold bg-red-500 text-white hover:bg-red-400 transition-colors text-base">
              Shop Recovery Peptides <ArrowRight className="w-4 h-4" />
            </Link>
            <Link href="/products"
